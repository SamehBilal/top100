...
<head>
    <meta charset="UTF-8" />
    <meta name="description" content="top applications">
    <meta name="keywords" content="application,top application,mobile,mobile application,mobile,برامج,برامج موبايل,mobile store,store">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('css/default(1).css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('css/component(1).css')}}" />
    ...
    <div class="main">
        <header class="codrops-header">
            <h1>
                ...
                Applications <span>The top 100 mobile applications in Egypt</span>
            </h1>
            @if(!Auth::guest())
        ...
        <ul class="cbp-ig-grid">
            {{--@for($r=1;$r<11;$r++)--}}@foreach($apps as $app)
            <li style="margin-top: 1.3em">
                <a href="#">
                    <span class="cbp-ig-icon">
                        <img class="img" src="{{asset('img/bag.png')}}" alt="">
                    </span>
                    <br>
                    <span>{{$app->name}}</span>
                    <br>
                    ...
                    <span class="rate{{$app->id}} rate-button" data-toggle="modal" data-target=".bd-example-modal-sm">
