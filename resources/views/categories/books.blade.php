...
<head>
    ...
    <link href="{{asset('css/demobooks.css')}}" rel="stylesheet">
    <link href="{{asset('css/tooltip-flip.css')}}" rel="stylesheet">
        ...
        <div class="content">
            ...
            <div class="container row">
                <div class="col-md-offset-2 col-md-10">
                    <img src="{{asset('img/books3.png')}}" alt="" width="100%" height="100%">
                </div>
                    ...
                    <ul>
                        ...
                        <li id="num{{$i}}">
                            <a class="tooltip tooltip-effect-1" href="#">
                                <img src="../img/{{$i}}.png" alt="" width="30" height="30">
								<span class="tooltip-content">
									<span class="tooltip-front">
                                        <img src="../img/{{DB::table('books')->where('position', '=', $i)->value('image_path')}}" alt="user4" width="60px" height="60px"/>
                                    </span>
									<span class="tooltip-back">{{DB::table('books')->where('position', '=', $i)->value('name')}}
                                        <br>
                                    <span class=" rate-books">
                                        <i class="fa fa-star " aria-hidden="true"></i> {{DB::table('books')->where('position', '=', $i)->value('average')}}
                                    </span><br>
                                        <span class="rate{{$i}} rate-books rate-button" data-toggle="modal" data-target=".bd-example-modal-sm">
