...
<head>
    ...
    <meta charset="UTF-8" />
    <meta name="description" content="top mobiles">
    <meta name="keywords" content="mobile,mobile phone,phone,samsung,apple,nokia,iphone,موبايل,تليفون">
    ...
    <title>Top mobiles</title>
    <link rel="shortcut icon" href="../favicon.ico">
    <link rel="stylesheet" type="text/css" href="{{asset('css/normalize.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('css/default(2).css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('css/component(2).css')}}" />
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.rate{{$T}}').click(function(){
                $('#myform{{$T}}').attr("action", "/mobiles/update/{{$T}}");
                alert($("#myform{{$T}}").attr("action"));
            });
            @endfor
            @for($e=1;$e<11;$e++)
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        @for($r=1;$r<11;$r++)
                            <form id="myform{{$r}}" action="" method="post">
                                {{csrf_field()}}
    ...
    <div class="main">
        <header class="codrops-header">
            <h1>
                ...
                Mobiles <span>The top 100 mobiles in Egypt</span>
            </h1>
            @if(!Auth::guest())
            ...
            <li style="margin-top: 1.3em">
                <a href="#">
                    <span class="cbp-ig-icon">
                        <img class="img" src="{{asset('img/Stand.png')}}" alt="">
                    </span>
                    <br>
                    <span>
                        {{$mobile->name}}
                    ...
                    <span class="rate{{$mobile->id}} rate-button" data-toggle="modal" data-target=".bd-example-modal-sm">
