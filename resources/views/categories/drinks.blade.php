...
<head>
    <meta charset="UTF-8" />
    <meta name="description" content="top drinks">
    <meta name="keywords" content="juice,عصير, مشروب,drink">
    ...
    <link href="{{asset('css/demodrinks.css')}}" rel="stylesheet">
    <link href="{{asset('css/tooltip-round.css')}}" rel="stylesheet">
        ...
        <div class="content">
            ...
            <header class="codrops-header">
                <h1>
                    ...
                    Drinks <span>The top 100 drinks in Egypt</span>
                </h1>
                @if(!Auth::guest())
            ...
            <div class="container row">
                <div class="col-md-offset-3 col-md-4">
                    <img src="{{asset('img/talaga2.png')}}" alt="" width="100%" height="100%">
                </div>
                <div class="col-md-4">
                    <img src="{{asset('img/talaga1.png')}}" alt="" width="100%" height="100%">
                </div>
                <div class="dummy dummy-menu">
                    <ul>
                        @for($w=1;$w<11;$w++)
                        <li>
                            <a class="tooltip num{{$w}} tooltip-effect-1" href="#">
                                <img src="{{asset('img/'.$w.'.png')}}" alt="" width="40" height="40">
                                <span class="tooltip-content">
                                    {{DB::table('drinks')->where('position', '=', $w)->value('name')}}
                                    <br>
                                    <span class=" inbox">
                                        <i class="fa fa-star " aria-hidden="true"></i>
                                        {{DB::table('drinks')->where('position', '=', $w)->value('average')}}
                                    </span>
                                     <span class="inbox-rate inbox rate{{$w}} rate-button" data-toggle="modal" data-target=".bd-example-modal-sm">
