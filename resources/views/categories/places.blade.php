...
<head>
    ...
    <meta charset="UTF-8" />
    <meta name="description" content="top places">
    <meta name="keywords" content="going out,new city,torist,visting new places,خروجات,اماكن خروج">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('css/demoplaces.css')}}" />
                        ...
                        <div class="modal-body">
                            ...
                            @for($r=1;$r<11;$r++)
                                <form id="myform{{$r}}" action="" method="get">
                                    <span class="sub{{$r}}" style="cursor: pointer;color: black"><i class="star{{$r}} fa fa-star-o fa-2x" aria-hidden="true"></i>{{$r}}</span>
        ...
        <div id="">
            <header class="codrops-header">
                <h1>
                    ...
                    Places <span>The top 100 places in Egypt</span>
                </h1>
                @if(!Auth::guest())
            ...
            <ul>
                ...
                <li>
                    <a class="tooltip" href="#">
                        <i class="fa fa-fw fa-map-o fa-2x"></i>
                        <span class="tooltip-content">{{DB::table('places')->where('position', '=', $i)->value('name')}}  <br><br>

                            <span class="new rating">
                                <i class="fa fa-star fa-2x" aria-hidden="true"></i>
                                {{DB::table('places')->where('position', '=', $i)->value('average')}}
                            </span>
                            <br>
                            <span class="new rate rate{{$i}}" data-toggle="modal" data-target=".bd-example-modal-sm">
